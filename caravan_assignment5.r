...
#The following code is executed in JupyterLab and the output is saved in a seperate file named output1.txt
...
#Based on the predictions made, the company should not continue to sell the product.
